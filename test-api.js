...
function testApi() {
    return __awaiter(this, void 0, void 0, function () {
        var api, projects, error_1, tasks, error_2, project, error_3, task, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    api = new api_1.TickTickApi();
                ...
                case 9:
                    ...
                    return [4 /*yield*/, api.createProject('Test Project', '#FF5733')];
                case 10:
                    project = _a.sent();
                ...
                case 11:
                    error_3 = _a.sent();
                    console.log('Expected error:', error_3.message);
                    return [3 /*break*/, 12];
                case 12:
                ...
                case 15:
                    error_4 = _a.sent();
                    console.log('Expected error:', error_4.message);
                    return [3 /*break*/, 16];
